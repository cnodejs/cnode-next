    ...
    <Layout>
      <DirectoryPage>
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[13rem_minmax(0,1fr)]">
          <nav
            aria-label="关于页面导航"
            className="flex gap-2 overflow-x-auto lg:sticky lg:top-24 lg:self-start lg:flex-col"
          >
            {[
              ["社区介绍", "#community"],
              ["参与指南", "#guide"],
          ...
          <div data-slot="about-sections" className="flex min-w-0 flex-col gap-12 md:gap-16">
            <section id="community" className="scroll-mt-24">
              <SectionIntro
                eyebrow="COMMUNITY"
                title="关于 CNode"
                description="CNode 面向中文 Node.js 与现代 Web 开发者，希望让真实问题、可复用经验和生态实践被长期检索与讨论。"
              />
            ...
            <section id="guide" className="scroll-mt-24">
              <SectionIntro
                ...
                title="参与指南"
                description="从浏览讨论到发布内容，选择清晰的上下文比追求形式更重要。"
              />
            ...
            <section id="discussion" className="scroll-mt-24">
              <SectionIntro
                eyebrow="DISCUSSION"
                title="讨论与内容规范"
                description="高质量讨论从可复现的信息、可阅读的格式和对彼此时间的尊重开始。"
              />
            ...
            <section id="cooperation" className="scroll-mt-24">
              <SectionIntro
                ...
                title="社区合作"
                description="首页保留一个社区合作展示位，用于介绍与 CNode 读者相关的开源项目、开发者工具和技术活动。合作内容需要明确来源并与 Node.js 开发者相关。"
              />
              <ItemGroup className="mt-4 grid gap-4 md:grid-cols-3">
            ...
            <section id="client" className="scroll-mt-24">
              <SectionIntro
                eyebrow="COMMUNITY CLIENT"
                title="社区客户端"
                description="CNode 曾有由社区开发者维护的 React Native 客户端。它不是本站官方发行的软件，安装或使用前请先查看原项目的维护状态、平台支持和安全说明。"
              />
              <Button
                render={
                  <a
                    href="https://github.com/soliury/noder-react-native/blob/master/README.md"
                    target="_blank"
            ...
            <section id="faq" className="scroll-mt-24">
              <SectionIntro
                eyebrow="FAQ"
                title="常见问题"
                description="账号、消息、话题和回复的常见使用说明。"
              />
