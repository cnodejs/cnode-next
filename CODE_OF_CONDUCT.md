...
acting via an official social media account, or acting as an appointed
...
private maintainer channel described in [SECURITY.md](SECURITY.md) or a direct
...
1. **Correction**: Community impact: use of inappropriate language or other
   behavior deemed unprofessional or unwelcome in the community. Consequence:
   a written warning from community leaders, providing clarity around the
...
2. **Warning**: Community impact: a violation through a single incident or
   ...
   interaction with those enforcing the Code of Conduct, for a specified period
   of time. This includes avoiding interactions in community spaces as well as
...
4. **Permanent Ban**: Community impact: demonstrating a pattern of violation of
   community standards, sustained inappropriate behavior, harassment of an
