# github-collaboration-templates Specification

## Purpose

定义 GitHub Issue 与 Pull Request 协作模板的最小信息收集边界，确保贡献者只需提供解决问题所必需的上下文，并通过私密渠道报告安全问题，同时避免模板重复内部流程、代码差异或 CI 已能表达的信息。
